...
/* harmony import */ var _ui_Csrf_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ui/Csrf.js */ "./resources/js/ui/Csrf.js");
...
var Contact = function Contact(_ref) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.post(action, contactForm).then(function (res) {
                  console.log(res);
                  setSuccess(true);
  ...
  var ValidateChanmps = function ValidateChanmps(data) {
    ...
    if (phoneNumber !== "" && !_utils__WEBPACK_IMPORTED_MODULE_8__.validate.IsPhone(phoneNumber)) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, success ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_6__.Success, {
    ...
    type: "text",
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('phoneNumber', errors),
    placeholder: "Phone *",
    name: "phoneNumber",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('phoneNumber', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "my-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "text",
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('subject', errors),
    placeholder: "Subject *",
    name: "subject",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('subject', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "my-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("textarea", {
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('message', errors),
    placeholder: "Message *",
    rows: "3",
    name: "message",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('message', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "my-4"
...
(0,preact_custom_element__WEBPACK_IMPORTED_MODULE_3__.default)(Contact, "contact-form", []);
})();
