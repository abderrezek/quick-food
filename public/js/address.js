...
/***/ "./resources/js/components/Address/NewEditAddress.js":
/*!***********************************************************!*\
  !*** ./resources/js/components/Address/NewEditAddress.js ***!
  \***********************************************************/
...
/* harmony import */ var _ui_Button_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../ui/Button.js */ "./resources/js/ui/Button.js");
/* harmony import */ var _ui_Alert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../ui/Alert */ "./resources/js/ui/Alert.js");
/* harmony import */ var _ui_Method_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../ui/Method.js */ "./resources/js/ui/Method.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utils */ "./resources/js/utils/index.js");
/* harmony import */ var _ui_Modal_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../ui/Modal.js */ "./resources/js/ui/Modal.js");
...
var NewEditAddress = function NewEditAddress(_ref) {
  ...
  var _useState3 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(""),
      ...
      slugOld = _useState4[0],
      setSlugOld = _useState4[1];

  var _useState5 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(false),
      _useState6 = _slicedToArray(_useState5, 2),
      loading = _useState6[0],
      setLoading = _useState6[1];

  var _useState7 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)({}),
      _useState8 = _slicedToArray(_useState7, 2),
      errors = _useState8[0],
      setErrors = _useState8[1];

  var _useState9 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)({}),
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.post(act, addressForm).then(function (res) {
                  console.log(res);
                  setSuccess({
                    succConnexion: res.data.message
                  });
                  loadData();
                })["catch"](function (err) {
                  console.log(err.response); // 429 (Too Many Requests)

                  if (err.response && "message" in err.response.data) {
                    if (err.response.status === 409) {
                      setErrors({
                        errConnexion: err.response.data.message
                      });
                    }
                  }
                })["finally"](function () {
                  setLoading(false); // hideModal();
                  // setErrors({});
                  // setSuccess({});
                });
              }
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Modal_js__WEBPACK_IMPORTED_MODULE_8__.default, {
    title: title,
    onClose: onClose,
    show: show,
    footer: false
  }, loading ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  }, "Loading..."))) : (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    className: "needs-validation",
    method: "post",
    action: action,
    onSubmit: onSubmit
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Method_js__WEBPACK_IMPORTED_MODULE_6__.default, {
    name: "POST"
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  ...
  }, "Adresse"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("textarea", {
    className: _utils__WEBPACK_IMPORTED_MODULE_7__.utils.classError('address', errors),
    name: "address",
    id: "address",
    rows: "3",
    value: data && data['address'],
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_7__.utils.showError('address', errors)), success && success['succConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Success, {
    responces: success['succConnexion']
  }) : null, errors && errors['errConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Errors, {
    errors: errors['errConnexion']
  }) : null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "d-grid mt-3"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Button_js__WEBPACK_IMPORTED_MODULE_4__.Button, {
    title: dataObj ? "Modifier" : "Ajouter",
    isLoading: loading
  }))));
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (NewEditAddress);
...
"use strict";
/*!****************************************************!*\
  !*** ./resources/js/components/Address/Address.js ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
...
/* harmony import */ var _ui_Method_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../ui/Method.js */ "./resources/js/ui/Method.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utils */ "./resources/js/utils/index.js");
/* harmony import */ var _NewEditAddress_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./NewEditAddress.js */ "./resources/js/components/Address/NewEditAddress.js");
...
var Address = function Address(_ref) {
  var locations = _ref.data,
      actionaa = _ref.actionaa,
      actionga = _ref.actionga;
  ...
  var _useState5 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(null),
      _useState6 = _slicedToArray(_useState5, 2),
      errors = _useState6[0],
      setErrors = _useState6[1];

  var _useState7 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(null),
      _useState8 = _slicedToArray(_useState7, 2),
      success = _useState8[0],
      setSuccess = _useState8[1];

  var _useState9 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)("add"),
      _useState10 = _slicedToArray(_useState9, 2),
      type = _useState10[0],
      setType = _useState10[1];

  var _useState11 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)({}),
      _useState12 = _slicedToArray(_useState11, 2),
      dataEdit = _useState12[0],
      setDataEdit = _useState12[1];

  var _useState13 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(false),
  ...
  (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
    ...
    locations = locations.replace('}]', '');
    var objArrs = locations.split('},{');
    objArrs = objArrs.map(function (obj) {
      return "{".concat(obj, "}");
    });
    var data = [];
  ...
  var removeClick = function removeClick(slug) {
    if (confirm("do you want remove it?") == false) {
      return;
    }

    setLoading(true);
    axios["delete"]("".concat(actionaa, "/").concat(slug)).then(function (res) {
      console.log(res);
  ...
  var editClick = function editClick(address) {
    setDataEdit(address);
    setType("edit");
    setShow(true);
  };

  var _loadData = /*#__PURE__*/function () {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              setLoading(true);
              axios.get(actionga).then(function (res) {
                console.log(res);
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, errors && errors !== "" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Errors, {
    errors: errors
  }) : null, success && success !== "" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Success, {
    responces: success
  }) : null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
    ...
    className: "btn btn-primary",
    onClick: addClick
  }, "Ajouter un nouveau")), loading ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  }, "Loading..."))) : (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("table", {
    className: "table table-striped table-hover"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("thead", null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("tr", null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("th", {
    scope: "col"
  }, "#"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("th", {
    scope: "col"
  }, "Adresse"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("th", {
    scope: "col"
  }, "Nombre de fois"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("th", {
    scope: "col"
  }, "Action"))), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("tbody", null, data && data.map(function (obj, index) {
    return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("tr", {
      key: index
    }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("td", null, index + 1), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("td", null, obj.address), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("td", null, obj.number_times), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("td", null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
      className: "btn btn-danger me-1",
      onClick: function onClick() {
        return removeClick(obj.slug);
      }
    }, "Supprimer"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
  ...
  }))), type === "add" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_NewEditAddress_js__WEBPACK_IMPORTED_MODULE_8__.default, {
    action: actionaa,
    ...
    onClose: closeModal,
    title: "Ajouter"
  }) : type === "edit" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_NewEditAddress_js__WEBPACK_IMPORTED_MODULE_8__.default, {
    action: actionaa,
    loadData: function loadData() {
      return _loadData();
    },
...
(0,preact_custom_element__WEBPACK_IMPORTED_MODULE_3__.default)(Address, "address-form", []);
})();
