...
/***/ "./resources/js/components/UpdateInfo.js":
/*!***********************************************!*\
  !*** ./resources/js/components/UpdateInfo.js ***!
  \***********************************************/
...
/* harmony import */ var _ui_Csrf_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ui/Csrf.js */ "./resources/js/ui/Csrf.js");
...
var UpdateInfo = function UpdateInfo(_ref) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.put(action, loginForm).then(function (res) {
                  setSuccess({
  ...
  var ValidateChanmps = function ValidateChanmps(data) {
    ...
    if (email !== "" && !_utils__WEBPACK_IMPORTED_MODULE_8__.validate.IsEmail(email)) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    ...
    type: "text",
    name: "name",
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('name', errors),
    id: "nameE",
    value: data.name,
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('name', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "phoneE",
    className: "form-label"
  }, "T\xE9lephone"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "text",
    name: "phone",
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('phone', errors),
    id: "phoneE",
    value: data.phone,
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('phone', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "emailE",
    className: "form-label"
    ...
    type: "email",
    name: "email",
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('email', errors),
    id: "emailE",
    value: data.email,
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('email', errors)), success && success['succConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Success, {
...
var UpdatePassword = function UpdatePassword(_ref) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.put(action, updatePassword).then(function (res) {
                  // console.log(res);
                  setSuccess({
                    succConnexion: res.data.message
                  });
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    ...
    type: "password",
    name: "password",
    className: _utils__WEBPACK_IMPORTED_MODULE_7__.utils.classError('password', errors),
    id: "passwordE",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_7__.utils.showError('password', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "confirmPasswordE",
    className: "form-label"
  }, "Confirmez le mot de passe"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "password",
    name: "confirm_password",
    className: _utils__WEBPACK_IMPORTED_MODULE_7__.utils.classError('confirm_password', errors),
    id: "confirmPasswordE",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_7__.utils.showError('confirm_password', errors)), success && success['succConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Success, {
    responces: success['succConnexion']
  }) : null, errors && errors['errConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Errors, {
    errors: errors['errConnexion']
  }) : null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
/* harmony import */ var _UpdateInfo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UpdateInfo */ "./resources/js/components/UpdateInfo.js");
/* harmony import */ var _UpdatePassword__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./UpdatePassword */ "./resources/js/components/UpdatePassword.js");
...
var Profile = function Profile(props) {
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_UpdateInfo__WEBPACK_IMPORTED_MODULE_3__.default, {
    action: props.actionui,
    data: props.data
  }), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_UpdatePassword__WEBPACK_IMPORTED_MODULE_4__.default, {
    action: props.actionup
  }));
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Profile);
(0,preact_custom_element__WEBPACK_IMPORTED_MODULE_2__.default)(Profile, "profile-form", []);
})();
