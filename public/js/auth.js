...
/* harmony import */ var _ForgotPassword__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ForgotPassword */ "./resources/js/components/ForgotPassword.js");
...
var Auth = function Auth(_ref) {
  var type = _ref.type,
      intended = _ref.intended;
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, type === "login" ? (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_login__WEBPACK_IMPORTED_MODULE_2__.default, {
    intended: intended
  }) : type === "register" ? (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_register__WEBPACK_IMPORTED_MODULE_3__.default, {
    intended: intended
  }) : type === "forgot-password" ? (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_ForgotPassword__WEBPACK_IMPORTED_MODULE_4__.default, null) : null);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Auth);
(0,preact_custom_element__WEBPACK_IMPORTED_MODULE_1__.default)(Auth, "auth-form", []);

/***/ }),

/***/ "./resources/js/components/ForgotPassword.js":
/*!***************************************************!*\
  !*** ./resources/js/components/ForgotPassword.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _ui_Button_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ui/Button.js */ "./resources/js/ui/Button.js");
/* harmony import */ var _ui_Alert__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../ui/Alert */ "./resources/js/ui/Alert.js");
/* harmony import */ var _ui_Method_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ui/Method.js */ "./resources/js/ui/Method.js");
/* harmony import */ var _ui_Csrf_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ui/Csrf.js */ "./resources/js/ui/Csrf.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils */ "./resources/js/utils/index.js");
/* harmony import */ var _Auth__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Auth */ "./resources/js/components/Auth.js");
...
var ForgotPassword = function ForgotPassword(_ref) {
  ...
  var _useState3 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(false),
  ...
  var _useState7 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)(false),
      _useState8 = _slicedToArray(_useState7, 2),
      success = _useState8[0],
      setSuccess = _useState8[1];

  var _useState9 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)("forgot-password"),
      _useState10 = _slicedToArray(_useState9, 2),
      typeLink = _useState10[0],
      setTypeLink = _useState10[1];
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.post(ziggy__WEBPACK_IMPORTED_MODULE_3___default()('password.email', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_4__.Ziggy), forgotPasswordForm).then(function (res) {
                  setSuccess(true);

                  if (res.status === 200) {
                    window.location = ziggy__WEBPACK_IMPORTED_MODULE_3___default()('login', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_4__.Ziggy);
                  }
                })["catch"](function (err) {
  ...
  var ValidateChanmps = function ValidateChanmps(data) {
    var errExist = false;
    var email = data.email; // email

    if (email === "") {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
    ...
    if (email !== "" && !_utils__WEBPACK_IMPORTED_MODULE_9__.validate.IsEmail(email)) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
  ...
  var onChange = function onChange(e) {
    return setData(function (state) {
      return _objectSpread(_objectSpread({}, state), {}, _defineProperty({}, e.target.name, e.target.value));
    });
  };

  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, typeLink === "login" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_Auth__WEBPACK_IMPORTED_MODULE_10__.default, {
    type: typeLink
  }) : typeLink === "register" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_Auth__WEBPACK_IMPORTED_MODULE_10__.default, {
    type: typeLink
  }) : typeLink === "forgot-password" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    className: "needs-validation",
    method: "post",
    action: ziggy__WEBPACK_IMPORTED_MODULE_3___default()('password.email', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_4__.Ziggy),
    onSubmit: onSubmit
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Csrf_js__WEBPACK_IMPORTED_MODULE_8__.default, {
    value: csrf
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Method_js__WEBPACK_IMPORTED_MODULE_7__.default, {
    name: "POST"
  ...
  }, "E-mail"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "email",
    name: "email",
    className: _utils__WEBPACK_IMPORTED_MODULE_9__.utils.classError('email', errors),
    id: "emailFP",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_9__.utils.showError('email', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "d-grid my-3"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Button_js__WEBPACK_IMPORTED_MODULE_5__.Button, {
    title: "Send",
    isLoading: loading
  })), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", {
    className: "m-0 mt-3 text-center"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    className: "text-primary text-decoration-none",
    href: "#",
    onClick: function onClick() {
      return setTypeLink("register");
    }
  }, "Ne pas avoir de compte")), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", {
    className: "m-0 mb-2 text-center"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    className: "text-primary text-decoration-none",
    href: "#",
    onClick: function onClick() {
      return setTypeLink("login");
    }
  }, "S'identifier"))) : null);
};
...
/* harmony import */ var _ui_Button_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../ui/Button.js */ "./resources/js/ui/Button.js");
/* harmony import */ var _ui_Alert__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ui/Alert */ "./resources/js/ui/Alert.js");
/* harmony import */ var _ui_Method_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ui/Method.js */ "./resources/js/ui/Method.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils */ "./resources/js/utils/index.js");
/* harmony import */ var _Auth__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Auth */ "./resources/js/components/Auth.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
var Login = function Login(_ref) {
  ...
  var _useState9 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)("login"),
      _useState10 = _slicedToArray(_useState9, 2),
      typeLink = _useState10[0],
      setTypeLink = _useState10[1];
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.post(ziggy__WEBPACK_IMPORTED_MODULE_4___default()('login', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy), loginForm).then(function (res) {
                  setSuccess(true);

                  if (res.status === 200) {
                    if (intended === ziggy__WEBPACK_IMPORTED_MODULE_4___default()('checkout.index', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy)) {
                      window.location.href = ziggy__WEBPACK_IMPORTED_MODULE_4___default()('checkout.index', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy);
                    } else {
                      window.location.href = ziggy__WEBPACK_IMPORTED_MODULE_4___default()('site.index', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy);
                    }
                  }
                })["catch"](function (err) {
                  ...
                  if (err.response && "errors" in err.response.data) {
                    ...
                    if (err.response.status === 422) {
                      setErrors({
                        errConnexion: err.response.data.errors.email
                      });
                      return;
                    }

                    setErrors({
                      errConnexion: "Trop de demandes"
                    });
                  }
                })["finally"](function () {
                  setLoading(false);
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, typeLink === "login" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    className: "needs-validation",
    method: "post",
    action: ziggy__WEBPACK_IMPORTED_MODULE_4___default()('login', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy),
    onSubmit: onSubmit
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Method_js__WEBPACK_IMPORTED_MODULE_8__.default, {
    name: "POST"
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    ...
    "for": "passwordL",
    className: "form-label"
  }, "Mot de passe"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "password",
    name: "password",
    className: _utils__WEBPACK_IMPORTED_MODULE_9__.utils.classError('password', errors),
    id: "passwordL",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_9__.utils.showError('password', errors)), errors['errConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_7__.Errors, {
    errors: errors['errConnexion']
  }) : null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "d-grid my-3"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Button_js__WEBPACK_IMPORTED_MODULE_6__.Button, {
    title: "Connexion",
    isLoading: loading
  })), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", {
    className: "m-0 text-center"
  }, "- OR -"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", {
    className: "m-0 mt-3 text-center"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    className: "text-primary text-decoration-none",
    href: "#",
    onClick: function onClick() {
      return setTypeLink("forgot-password");
    }
  }, "Mot de passe oubli\xE9")), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", {
    className: "m-0 mb-2 text-center"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    className: "text-primary text-decoration-none",
    href: "#",
  ...
  }, "Cr\xE9ez votre compte"))) : typeLink === "register" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_Auth__WEBPACK_IMPORTED_MODULE_10__.default, {
    type: typeLink
  }) : typeLink === "forgot-password" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_Auth__WEBPACK_IMPORTED_MODULE_10__.default, {
    type: typeLink
  }) : null);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Login); // register(
//     Login,
//     "login-form",
//     []
// );
...
/* harmony import */ var _ui_Alert__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ui/Alert */ "./resources/js/ui/Alert.js");
/* harmony import */ var _ui_Method_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ui/Method.js */ "./resources/js/ui/Method.js");
/* harmony import */ var _ui_Csrf_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../ui/Csrf.js */ "./resources/js/ui/Csrf.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils */ "./resources/js/utils/index.js");
/* harmony import */ var _Auth__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Auth */ "./resources/js/components/Auth.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
var Register = function Register(_ref) {
  ...
  var _useState9 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)("register"),
      _useState10 = _slicedToArray(_useState9, 2),
      typeLink = _useState10[0],
      setTypeLink = _useState10[1];
            ...
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                loginForm = {
                  ...
                  email: data.email,
                  password: data.password,
                  password_confirmation: data.confirm_password // agree: data.agree

                };
                axios.post(ziggy__WEBPACK_IMPORTED_MODULE_4___default()('register', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy), loginForm).then(function (res) {
                  setSuccess(true);
                  console.log(res); // setErrors({ errConnexion : "Trop de demandes" });
  ...
  var ValidateChanmps = function ValidateChanmps(data) {
    ...
    if (phone !== "" && !_utils__WEBPACK_IMPORTED_MODULE_10__.validate.IsPhone(phone)) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
    ...
    if (email !== "" && !_utils__WEBPACK_IMPORTED_MODULE_10__.validate.IsEmail(email)) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
          email: "Email not valid"
        });
    ...
    if (password !== "" && password.length < 8) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
          password: "Password is less then 8"
        });
      });
      setLoading(false);
      errExist = true;
    ...
    if (password !== "" && password !== confirm_password) {
      setErrors(function (errs) {
        return _objectSpread(_objectSpread({}, errs), {}, {
          password: "Password Confirmation must be equel password"
        });
      });
      setLoading(false);
      errExist = true;
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, typeLink === "register" ? !success ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    className: "needs-validation",
    method: "post",
    action: ziggy__WEBPACK_IMPORTED_MODULE_4___default()('register', undefined, undefined, _ziggy__WEBPACK_IMPORTED_MODULE_5__.Ziggy),
    onSubmit: onSubmit
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Method_js__WEBPACK_IMPORTED_MODULE_8__.default, {
    name: "POST"
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "for": "nameR",
    className: "form-label"
  }, "Name"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "text",
    name: "name",
    className: _utils__WEBPACK_IMPORTED_MODULE_10__.utils.classError('name', errors),
    id: "nameR",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_10__.utils.showError('name', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "phoneR",
    className: "form-label"
  }, "Phone"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "text",
    name: "phone",
    className: _utils__WEBPACK_IMPORTED_MODULE_10__.utils.classError('phone', errors),
    id: "phoneR",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_10__.utils.showError('phone', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "emailR",
    className: "form-label"
    ...
    type: "email",
    name: "email",
    className: _utils__WEBPACK_IMPORTED_MODULE_10__.utils.classError('email', errors),
    id: "emailR",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_10__.utils.showError('email', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "passwordR",
    className: "form-label"
    ...
    type: "password",
    name: "password",
    className: _utils__WEBPACK_IMPORTED_MODULE_10__.utils.classError('password', errors),
    id: "passwordR",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_10__.utils.showError('password', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "confirmPasswordR",
    className: "form-label"
  }, "Confirmez le mot de passe"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    type: "password",
    name: "confirm_password",
    className: _utils__WEBPACK_IMPORTED_MODULE_10__.utils.classError('confirm_password', errors),
    id: "confirmPasswordR",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_10__.utils.showError('confirm_password', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "form-check mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
    className: _utils__WEBPACK_IMPORTED_MODULE_10__.utils.classErrorCheckBox('agree', errors),
    name: "agree",
    type: "checkbox",
    value: "true",
    id: "agreeR",
    ...
    "for": "agreeR"
  }, "J'accepte de recevoir des informations commerciales \xE0 l'adresse e-mail indiqu\xE9e (pas obligatoire)"), _utils__WEBPACK_IMPORTED_MODULE_10__.utils.showError('agree', errors)), errors['errConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_7__.Errors, {
    errors: errors['errConnexion']
  }) : null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "d-grid my-3"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Button_js__WEBPACK_IMPORTED_MODULE_6__.Button, {
    ...
    className: "m-0 mb-2 text-center"
  }, "Vous avez d\xE9j\xE0 un compte?", " ", (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    className: "text-primary text-decoration-none",
    href: "#",
    onClick: function onClick() {
      return setTypeLink("login");
    }
  }, "Connexion"))) : (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_7__.Success, {
  ...
  }) : typeLink === "login" ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_Auth__WEBPACK_IMPORTED_MODULE_11__.default, {
    type: typeLink
  }) : null);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Register); // register(
//     Register,
//     "register-form",
//     []
// );
...
var Alert = function Alert(_ref) {
  var msgs = _ref.msgs,
      type = _ref.type,
      dismissing = _ref.dismissing;
  var button = null;
  var classes = "alert alert-".concat(type);

  if (dismissing) {
    classes += ' alert-dismissible fade show';
    button = (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("button", {
      type: "button",
      className: "btn-close",
      dataBsDismiss: "alert",
      ariaLabel: "Close"
  ...
  return msgs !== null ? (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    className: classes,
    role: "alert"
  }, msgs, button) : null;
};
...
var Success = function Success(_ref2) {
  var responces = _ref2.responces,
      _ref2$dismissing = _ref2.dismissing,
      dismissing = _ref2$dismissing === void 0 ? false : _ref2$dismissing;
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Alert, {
    type: "success",
    msgs: responces,
    dismissing: dismissing
  });
};
var Errors = function Errors(_ref3) {
  var errors = _ref3.errors,
      _ref3$dismissing = _ref3.dismissing,
      dismissing = _ref3$dismissing === void 0 ? false : _ref3$dismissing;
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Alert, {
    type: "danger",
    msgs: errors,
    dismissing: dismissing
...
/* harmony export */ });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
var _excluded = ["type", "btnType", "title", "isLoading"];
...
var Button = function Button(_ref) {
  var _ref$type = _ref.type,
      ...
      btnType = _ref$btnType === void 0 ? "primary" : _ref$btnType,
      title = _ref.title,
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("button", _extends({
    "class": classes,
    type: type
  }, rest), loading, " ", title);
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Csrf);

/***/ }),

/***/ "./resources/js/ui/Method.js":
/*!***********************************!*\
  !*** ./resources/js/ui/Method.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "validate": () => (/* reexport module object */ _validate__WEBPACK_IMPORTED_MODULE_0__),
/* harmony export */   "utils": () => (/* reexport module object */ _utils__WEBPACK_IMPORTED_MODULE_1__)
/* harmony export */ });
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate */ "./resources/js/utils/validate.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./resources/js/utils/utils.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "classError": () => (/* binding */ classError),
/* harmony export */   "classErrorCheckBox": () => (/* binding */ classErrorCheckBox),
/* harmony export */   "showError": () => (/* binding */ showError)
/* harmony export */ });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");

var classError = function classError(name, errors) {
  return name in errors ? "form-control is-invalid" : "form-control";
};
var classErrorCheckBox = function classErrorCheckBox(name, errors) {
  return name in errors ? "form-check-input is-invalid" : "form-check-input";
};
...
var IsPhone = function IsPhone(mobile) {
  var re = /^0(5|6|7)[0-9]{8}$/;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/components/Auth.js");
/******/ 	
/******/ })()
;