...
window.loadJS = function loadJS(file) {
  var urlJS = "/js/".concat(file);

  if (document.querySelector("script[src=\"".concat(urlJS, "\"]"))) {
    return;
  }
...
window.loadContent = function loadContent(id, url, fileJS) {
  IfExist(id, function (elem) {
    if (elem.dataset.url === undefined || elem.dataset.url !== url) {
      ...
      loadJS(fileJS);
      axios.get("/modals/".concat(url)).then(function (res) {
        if (res.status === 200) {
          elem.innerHTML = '';
...
// submit form
ClickAction('email-sender', function (e, elem) {
  e.preventDefault();
...
ClickAction('login-modal', function (e, elem) {
  loadContent('load-modal', 'login', 'auth.js');
});
ClickAction('register-modal', function (e, elem) {
...
/*!*****************************!*\
  !*** ./resources/js/app.js ***!
  \*****************************/
__webpack_require__(/*! ./funcs.js */ "./resources/js/funcs.js");
