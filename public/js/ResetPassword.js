...
var ResetPassword = function ResetPassword(_ref) {
  var csrf = _ref.csrf,
      email = _ref.email,
      action = _ref.action,
      csrflogin = _ref.csrflogin,
      actionlogin = _ref.actionlogin;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (ValidateChanmps(data)) {
                ...
                axios.post(action, forgotPasswordForm).then(function (res) {
                  if (res.status === 200) {
                    ...
                    axios.post(actionlogin, loginForm).then(function (resL) {
                      if (resL.status === 200) {
                        window.location = window.location.origin;
                      }
                    })["catch"](function (errL) {
                      ...
                      if (errL.response && "errors" in errL.response.data) {
                        ...
                        if (errL.response.status === 422) {
                          setErrors({
                            errConnexion: errL.response.data.errors.email
                          });
                          return;
                        }
  ...
  var ValidateChanmps = function ValidateChanmps(data) {
    ...
    var email = data.email,
        password = data.password,
        confirm_password = data.confirm_password; // email
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("form", {
    className: "needs-validation",
    method: "post",
    action: action,
    onSubmit: onSubmit
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Csrf_js__WEBPACK_IMPORTED_MODULE_7__.default, {
    csrf: csrf
    ...
    id: "email",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('email', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "password",
    className: "form-label"
    ...
    type: "password",
    name: "password",
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('password', errors),
    id: "password",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('password', errors)), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "mb-2"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
    "for": "confirmPassword",
    className: "form-label"
    ...
    className: _utils__WEBPACK_IMPORTED_MODULE_8__.utils.classError('confirm_password', errors),
    id: "confirmPassword",
    onChange: onChange
  }), _utils__WEBPACK_IMPORTED_MODULE_8__.utils.showError('confirm_password', errors)), success['succConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Success, {
    errors: success['succConnexion']
  }) : null, errors['errConnexion'] != null ? (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_ui_Alert__WEBPACK_IMPORTED_MODULE_5__.Errors, {
...
(0,preact_custom_element__WEBPACK_IMPORTED_MODULE_3__.default)(ResetPassword, "reset-password-form", []);
})();
